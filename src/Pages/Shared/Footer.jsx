            ...
            <div className="grid lg:grid-cols-12 gap-10 md:gap-20    ">
              <div className="pb-6 md:pb-0 md:col-span-5">
                ...
                <p className="text-sm mb-6">
                  NovaNews, we are dedicated to bringing you the latest and most
                  insightful news from around the globe. Join our community and
                  stay connected with the news that matters most to you. <br />{" "}
                  Stay Informed. Stay Engaged. Stay NovaNews!
                </p>
                <button className="font-bold text-xl py-1 md:py-2 rounded-full px-3 md:px-8 bg-[#FF2400] transition-all shadow-md duration-300 border-y border-[#FF664D] hover:bg-[#ff5537] text-white">
                  Work with Us
                </button>
              </div>
                ...
                <ul className="space-y-1">
                  <li>
                    <a
                      rel="noopener  noreferrer"
                      href="#"
                      className="flex items-center gap-2 hover:text-[#dadada]"
                    >
                  ...
                  <li>
                    <a
                      ...
                      className="flex items-center gap-2 hover:text-[#dadada]"
                    >
                      <FaAngleRight /> Subscription plans
                    </a>
                  </li>
                  <li>
                    <a
                      ...
                      className="flex items-center gap-2 hover:text-[#dadada]"
                    >
                      <FaAngleRight /> Pricing and costs
                    </a>
                  </li>
                </ul>
              </div>
          ...
          <div>
            <div className="flex gap-3">
              <a
                ...
                href="#"
                title="Email"
                className="flex items-center justify-center w-10 h-10 rounded-full bg-[#FF2400] text-white"
              >
                <svg
